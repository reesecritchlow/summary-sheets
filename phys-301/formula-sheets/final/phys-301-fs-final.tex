...
\begin{multicols*}{2}
    ...
    \formbox{Magnetostatics in Matter}{
        ...
        \begin{tabular}{ m{12em} m{20em}  }
            ...
            Dipole Field: & $\ds \vec{B} = \frac{\mu_0 \vec{m}}{4\pi r^3}(2\cos(\theta)\hat{r} + \sin(\theta)\hat{\theta})$, for $\vec{m} = m\hat{z}$\\
        \end{tabular}}
    }
    \formbox{Electrodynamics}{
        ...
        \begin{tabular}{ m{12em} m{25em}  }
            ...
            Electromotive Force: &
            \begin{tabular}[t]{l}          
                $\displaystyle \mathcal{E} = \frac{F_\textrm{mag, tot}}{Q} = \int (\vec{v} \times \vec{B}) d \vec{l}$\\
    ...
    \formbox{Common Fields}{
        {\renewcommand{\arraystretch}{2}%
        \begin{tabular}{ m{12em} m{25em}  }
            Magnetic Finite Wire: & $\displaystyle \frac{\mu_0}{4\pi}\frac{I}{R}(\sin (\theta_1) - \sin (\theta_2))$\\
            Magnetic Field of an Arc: & $\displaystyle \frac{\mu_0 I \theta}{4\pi R}$\\
